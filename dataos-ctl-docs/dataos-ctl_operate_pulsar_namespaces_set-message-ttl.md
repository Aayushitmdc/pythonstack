## dataos-ctl operate pulsar namespaces set-message-ttl
...
```
dataos-ctl operate pulsar namespaces set-message-ttl [flags]
```
...
```
  ...
  -h, --help                               help for set-message-ttl
  -t, --messageTTL int                     Message TTL in seconds
