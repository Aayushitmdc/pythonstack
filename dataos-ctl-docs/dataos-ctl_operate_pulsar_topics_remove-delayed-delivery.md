## dataos-ctl operate pulsar topics remove-delayed-delivery
...
```
dataos-ctl operate pulsar topics remove-delayed-delivery [flags]
```
...
```
  ...
  -h, --help                               help for remove-delayed-delivery
