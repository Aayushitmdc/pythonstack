## dataos-ctl operate pulsar namespaces set-max-producers-per-topic
...
```
dataos-ctl operate pulsar namespaces set-max-producers-per-topic [flags]
```
...
```
  ...
  -h, --help                               help for set-max-producers-per-topic
  -o, --output string                      The output format (text,json,yaml) (default "text")
      --size int                           max producers per topic (default -1)
