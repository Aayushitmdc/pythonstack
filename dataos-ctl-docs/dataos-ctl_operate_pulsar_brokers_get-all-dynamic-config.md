## dataos-ctl operate pulsar brokers get-all-dynamic-config
...
```
dataos-ctl operate pulsar brokers get-all-dynamic-config [flags]
```
...
```
  ...
  -h, --help                               help for get-all-dynamic-config
