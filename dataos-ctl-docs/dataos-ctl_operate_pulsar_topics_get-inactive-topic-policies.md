## dataos-ctl operate pulsar topics get-inactive-topic-policies
...
```
dataos-ctl operate pulsar topics get-inactive-topic-policies [flags]
```
...
```
  ...
  -h, --help                               help for get-inactive-topic-policies
