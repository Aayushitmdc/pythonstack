## dataos-ctl operate pulsar namespaces get-schema-validation-enforced
...
```
dataos-ctl operate pulsar namespaces get-schema-validation-enforced [flags]
```
...
```
  ...
  -h, --help                               help for get-schema-validation-enforced
