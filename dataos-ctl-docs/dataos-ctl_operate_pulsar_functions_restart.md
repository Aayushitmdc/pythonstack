## dataos-ctl operate pulsar functions restart
...
```
dataos-ctl operate pulsar functions restart [flags]
```
...
```
  ...
  -h, --help                               help for restart
      --instance-id string                 The function instanceId (restart all instances if instance-id is not provided)
