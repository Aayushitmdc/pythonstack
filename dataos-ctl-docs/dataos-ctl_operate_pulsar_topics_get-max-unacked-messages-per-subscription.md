## dataos-ctl operate pulsar topics get-max-unacked-messages-per-subscription
...
```
dataos-ctl operate pulsar topics get-max-unacked-messages-per-subscription [flags]
```
...
```
  ...
  -h, --help                               help for get-max-unacked-messages-per-subscription
