## dataos-ctl operate pulsar topics set-max-unacked-messages-per-consumer
...
```
dataos-ctl operate pulsar topics set-max-unacked-messages-per-consumer [flags]
```
...
```
  ...
  -h, --help                               help for set-max-unacked-messages-per-consumer
  -m, --maxNum int                         Max unacked messages per consumer for a topic
