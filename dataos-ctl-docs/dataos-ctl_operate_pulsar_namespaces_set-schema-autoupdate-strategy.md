## dataos-ctl operate pulsar namespaces set-schema-autoupdate-strategy
...
```
dataos-ctl operate pulsar namespaces set-schema-autoupdate-strategy [flags]
```
...
```
  ...
  -h, --help                               help for set-schema-autoupdate-strategy
