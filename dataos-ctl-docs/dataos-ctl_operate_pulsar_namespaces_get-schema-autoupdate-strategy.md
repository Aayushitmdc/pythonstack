## dataos-ctl operate pulsar namespaces get-schema-autoupdate-strategy
...
```
dataos-ctl operate pulsar namespaces get-schema-autoupdate-strategy [flags]
```
...
```
  ...
  -h, --help                               help for get-schema-autoupdate-strategy
