## dataos-ctl operate pulsar namespaces get-max-consumers-per-subscription
...
```
dataos-ctl operate pulsar namespaces get-max-consumers-per-subscription [flags]
```
...
```
  ...
  -h, --help                               help for get-max-consumers-per-subscription
