## dataos-ctl operate pulsar namespaces clear-offload-deletion-lag
...
```
dataos-ctl operate pulsar namespaces clear-offload-deletion-lag [flags]
```
...
```
  ...
  -h, --help                               help for clear-offload-deletion-lag
