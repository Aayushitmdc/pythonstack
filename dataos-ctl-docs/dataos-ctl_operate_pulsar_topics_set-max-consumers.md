## dataos-ctl operate pulsar topics set-max-consumers
...
```
dataos-ctl operate pulsar topics set-max-consumers [flags]
```
...
```
  ...
  -h, --help                               help for set-max-consumers
  -c, --max-consumers int                  Max consumers for a topic
