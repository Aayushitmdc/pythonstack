## dataos-ctl operate pulsar namespaces clear-backlog
...
```
dataos-ctl operate pulsar namespaces clear-backlog [flags]
```
...
```
    ...
    #Clear backlog for all topic of the namespace (namespace-name) with a bundle range <bundle>
...
```
  ...
  -f, --force                              Whether to force clear backlog without prompt
  -h, --help                               help for clear-backlog
