## dataos-ctl operate pulsar namespaces get-dispatch-rate

Get the default message dispatch rate of a namespace
...
```
dataos-ctl operate pulsar namespaces get-dispatch-rate [flags]
```
...
```
  ...
  -h, --help                               help for get-dispatch-rate
