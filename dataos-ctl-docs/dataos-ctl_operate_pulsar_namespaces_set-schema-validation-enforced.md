## dataos-ctl operate pulsar namespaces set-schema-validation-enforced
...
```
dataos-ctl operate pulsar namespaces set-schema-validation-enforced [flags]
```
...
```
  ...
  -h, --help                               help for set-schema-validation-enforced
