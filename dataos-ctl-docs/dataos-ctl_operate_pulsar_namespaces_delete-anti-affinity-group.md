## dataos-ctl operate pulsar namespaces delete-anti-affinity-group
...
```
dataos-ctl operate pulsar namespaces delete-anti-affinity-group [flags]
```
...
```
  ...
  -h, --help                               help for delete-anti-affinity-group
