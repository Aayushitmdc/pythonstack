## dataos-ctl operate pulsar namespaces set-max-consumers-per-topic
...
```
dataos-ctl operate pulsar namespaces set-max-consumers-per-topic [flags]
```
...
```
  ...
  -h, --help                               help for set-max-consumers-per-topic
  -o, --output string                      The output format (text,json,yaml) (default "text")
      --size int                           max consumers per topic (default -1)
