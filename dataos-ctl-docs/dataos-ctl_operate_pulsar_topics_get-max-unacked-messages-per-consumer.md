## dataos-ctl operate pulsar topics get-max-unacked-messages-per-consumer
...
```
dataos-ctl operate pulsar topics get-max-unacked-messages-per-consumer [flags]
```
...
```
  ...
  -h, --help                               help for get-max-unacked-messages-per-consumer
