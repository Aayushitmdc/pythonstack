## dataos-ctl operate pulsar namespaces get-max-consumers-per-topic
...
```
dataos-ctl operate pulsar namespaces get-max-consumers-per-topic [flags]
```
...
```
  ...
  -h, --help                               help for get-max-consumers-per-topic
