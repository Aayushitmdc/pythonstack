## dataos-ctl operate pulsar namespaces get-backlog-quotas
...
```
dataos-ctl operate pulsar namespaces get-backlog-quotas [flags]
```
...
```
  ...
  -h, --help                               help for get-backlog-quotas
