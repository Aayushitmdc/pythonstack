## dataos-ctl operate pulsar namespaces get-subscription-dispatch-rate
...
```
dataos-ctl operate pulsar namespaces get-subscription-dispatch-rate [flags]
```
...
```
  ...
  -h, --help                               help for get-subscription-dispatch-rate
