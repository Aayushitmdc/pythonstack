## dataos-ctl operate pulsar functions upload
...
```
dataos-ctl operate pulsar functions upload [flags]
```
...
```
  ...
  -h, --help                               help for upload
      --path string                        Path where the contents will to be stored
      --source-file string                 The file whose content will be uploaded
