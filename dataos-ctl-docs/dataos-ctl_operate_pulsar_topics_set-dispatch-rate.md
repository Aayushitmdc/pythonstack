## dataos-ctl operate pulsar topics set-dispatch-rate
...
```
dataos-ctl operate pulsar topics set-dispatch-rate [flags]
```
...
```
  -s, --admin-service-url string           The admin web service url that pulsarctl connects to. (default "http://localhost:8080")
      ...
      --byte-dispatch-rate int             byte-dispatch-rate (default -1 will be overwrite if not passed) (default -1)
      --dispatch-rate-period int           dispatch-rate-period in second type (default 1 second will be overwrite if not passed) (default 1)
  -h, --help                               help for set-dispatch-rate
      --msg-dispatch-rate int              message-dispatch-rate (default -1 will be overwrite if not passed) (default -1)
  -o, --output string                      The output format (text,json,yaml) (default "text")
      --relative-to-publish-rate           dispatch rate relative to publish-rate (if publish-relative flag is enabled then broker will apply throttling value to (publish-rate + dispatch rate))
