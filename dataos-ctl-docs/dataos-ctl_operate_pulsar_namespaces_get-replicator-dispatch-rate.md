## dataos-ctl operate pulsar namespaces get-replicator-dispatch-rate
...
```
dataos-ctl operate pulsar namespaces get-replicator-dispatch-rate [flags]
```
...
```
  ...
  -h, --help                               help for get-replicator-dispatch-rate
