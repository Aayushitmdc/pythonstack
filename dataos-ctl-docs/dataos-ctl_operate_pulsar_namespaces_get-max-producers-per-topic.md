## dataos-ctl operate pulsar namespaces get-max-producers-per-topic
...
```
dataos-ctl operate pulsar namespaces get-max-producers-per-topic [flags]
```
...
```
  ...
  -h, --help                               help for get-max-producers-per-topic
