## dataos-ctl operate pulsar topics set-delayed-delivery
...
```
dataos-ctl operate pulsar topics set-delayed-delivery [flags]
```
...
```
  ...
  -d, --disable                            Disable delayed delivery messages
  -e, --enable                             Enable delayed delivery messages
  -h, --help                               help for set-delayed-delivery
  -o, --output string                      The output format (text,json,yaml) (default "text")
  -t, --time string                        The tick time for when retrying on delayed delivery messages, affecting the accuracy of the delivery time compared to the scheduled time. (eg: 1s, 10s, 1m, 5h, 3d) (default "1s")
