## dataos-ctl operate pulsar topics set-max-unacked-messages-per-subscription
...
```
dataos-ctl operate pulsar topics set-max-unacked-messages-per-subscription [flags]
```
...
```
  ...
  -h, --help                               help for set-max-unacked-messages-per-subscription
  -m, --maxNum int                         Max unacked messages per subscription for a topic
