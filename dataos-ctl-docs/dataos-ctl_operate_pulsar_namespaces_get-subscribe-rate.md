## dataos-ctl operate pulsar namespaces get-subscribe-rate
...
```
dataos-ctl operate pulsar namespaces get-subscribe-rate [flags]
```
...
```
  ...
  -h, --help                               help for get-subscribe-rate
