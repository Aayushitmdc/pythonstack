## dataos-ctl operate pulsar namespaces set-subscription-auth-mode
...
```
dataos-ctl operate pulsar namespaces set-subscription-auth-mode [flags]
```
...
```
  ...
  -h, --help                               help for set-subscription-auth-mode
  -m, --mode string                        Subscription authorization mode of a namespace. (e.g. None, Prefix)
