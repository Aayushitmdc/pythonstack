## dataos-ctl operate pulsar topics delete
...
```
dataos-ctl operate pulsar topics delete [flags]
```
...
```
  ...
  -d, --delete-schema                      Delete schema while deleting topic
  -f, --force                              Close all producer/consumer/replicator and delete topic forcefully
  -h, --help                               help for delete
  -n, --non-partitioned                    Delete a non-partitioned topic
