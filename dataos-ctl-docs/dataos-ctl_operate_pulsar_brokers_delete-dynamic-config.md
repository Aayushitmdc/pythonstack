## dataos-ctl operate pulsar brokers delete-dynamic-config
...
```
dataos-ctl operate pulsar brokers delete-dynamic-config [flags]
```
...
```
  ...
  -h, --help                               help for delete-dynamic-config
