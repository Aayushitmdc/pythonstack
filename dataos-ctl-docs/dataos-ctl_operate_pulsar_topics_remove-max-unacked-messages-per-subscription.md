## dataos-ctl operate pulsar topics remove-max-unacked-messages-per-subscription
...
```
dataos-ctl operate pulsar topics remove-max-unacked-messages-per-subscription [flags]
```
...
```
  ...
  -h, --help                               help for remove-max-unacked-messages-per-subscription
