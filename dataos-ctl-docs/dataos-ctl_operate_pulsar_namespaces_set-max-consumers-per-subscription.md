## dataos-ctl operate pulsar namespaces set-max-consumers-per-subscription
...
```
dataos-ctl operate pulsar namespaces set-max-consumers-per-subscription [flags]
```
...
```
  ...
  -h, --help                               help for set-max-consumers-per-subscription
  -o, --output string                      The output format (text,json,yaml) (default "text")
      --size int                           max consumers per subscription (default -1)
