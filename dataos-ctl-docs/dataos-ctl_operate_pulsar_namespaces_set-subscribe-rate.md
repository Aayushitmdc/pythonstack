## dataos-ctl operate pulsar namespaces set-subscribe-rate
...
```
dataos-ctl operate pulsar namespaces set-subscribe-rate [flags]
```
...
```
  ...
  -h, --help                               help for set-subscribe-rate
  -o, --output string                      The output format (text,json,yaml) (default "text")
  -p, --period int                         dispatch rate period (default 30 second) (default 30)
  -m, --subscribe-rate int                 message dispatch rate (default -1) (default -1)
