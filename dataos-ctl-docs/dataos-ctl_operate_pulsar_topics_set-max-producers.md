## dataos-ctl operate pulsar topics set-max-producers
...
```
dataos-ctl operate pulsar topics set-max-producers [flags]
```
...
```
  ...
  -h, --help                               help for set-max-producers
  -p, --max-producers int                  Max producers for a topic
