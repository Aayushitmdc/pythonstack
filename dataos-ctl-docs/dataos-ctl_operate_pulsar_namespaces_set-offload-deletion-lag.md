## dataos-ctl operate pulsar namespaces set-offload-deletion-lag
...
```
dataos-ctl operate pulsar namespaces set-offload-deletion-lag [flags]
```
...
```
  ...
  -h, --help                               help for set-offload-deletion-lag
  -l, --lag string                         Duration to wait after offloading a ledger segment, before deleting the copy of that segment from cluster local storage. (e.g. 1s, 1m, 1h)
