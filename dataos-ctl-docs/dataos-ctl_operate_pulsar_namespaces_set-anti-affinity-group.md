## dataos-ctl operate pulsar namespaces set-anti-affinity-group
...
```
dataos-ctl operate pulsar namespaces set-anti-affinity-group [flags]
```
...
```
  ...
  -h, --help                               help for set-anti-affinity-group
