## dataos-ctl operate pulsar topics remove-max-unacked-messages-per-consumer
...
```
dataos-ctl operate pulsar topics remove-max-unacked-messages-per-consumer [flags]
```
...
```
  ...
  -h, --help                               help for remove-max-unacked-messages-per-consumer
