## dataos-ctl operate pulsar bookkeeper bookie expand-storage
...
```
dataos-ctl operate pulsar bookkeeper bookie expand-storage [flags]
```
...
```
  ...
  -h, --help                               help for expand-storage
