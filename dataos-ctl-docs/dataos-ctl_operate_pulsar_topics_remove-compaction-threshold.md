## dataos-ctl operate pulsar topics remove-compaction-threshold
...
```
dataos-ctl operate pulsar topics remove-compaction-threshold [flags]
```
...
```
  ...
  -h, --help                               help for remove-compaction-threshold
