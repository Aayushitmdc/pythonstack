## dataos-ctl operate pulsar topics compact-status
...
```
dataos-ctl operate pulsar topics compact-status [flags]
```
...
```
  ...
  -h, --help                               help for compact-status
  ...
  -w, --wait                               Wait for compacting to complete
```
