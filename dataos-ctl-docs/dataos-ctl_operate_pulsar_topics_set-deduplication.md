## dataos-ctl operate pulsar topics set-deduplication
...
```
dataos-ctl operate pulsar topics set-deduplication [flags]
```
...
```
  ...
  -d, --disable                            Disable deduplication
  -e, --enable                             Enable deduplication
  -h, --help                               help for set-deduplication
